//THIS IS NOT USED DUE TO MULTIPLE DATA TYPES.
//INSTEAD, THESE METHODS ARE JUST IMPLEMENTED IN THE FILES OF THE DATA TYPES (path.c, history.c, etc).
//THE METHODS FOR EACH DATA TYPE WILL NEED DISTINCT NAMES.
